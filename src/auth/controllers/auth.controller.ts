...
export class AuthController {
  ...
  @ApiUnauthorizedResponse({
    description: 'Credenciales inválidas. El correo electrónico o la contraseña no son correctos.',
  })
  ...
  @ApiUnauthorizedResponse({
    description: 'No autorizado. Se requiere un refresh token válido para renovar el token de acceso.',
  })
