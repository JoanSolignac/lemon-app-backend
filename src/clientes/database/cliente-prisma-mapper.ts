...
type PrismaSelectCliente = Prisma.ClienteGetPayload<{
  select: typeof SELECT_CLIENTES;
}>;
type PrismaTipoDocumento = PrismaSelectCliente['tipoDocumento'];
type PrismaTipoCliente = PrismaSelectCliente['tipoCliente'];

export const toPrismaTipoDocumento = (
  value: TipoDocumento,
): PrismaTipoDocumento => {
  return value as PrismaTipoDocumento;
};

export const toDomainTipoDocumento = (
  value: PrismaTipoDocumento,
): TipoDocumento => {
