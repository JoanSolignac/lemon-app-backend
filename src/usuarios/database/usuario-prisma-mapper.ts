...
type PrismaUsuario = Prisma.UsuarioGetPayload<Record<string, never>>;
type PrismaSelectUsuario = Prisma.UsuarioGetPayload<{
  select: typeof SELECT_USUARIOS;
}>;
type PrismaSelectUsuarioForAuth = Prisma.UsuarioGetPayload<{
  select: typeof SELECT_USUARIO_FOR_AUTH;
}>;
...
export const toDomainForAuth = (
  value: PrismaSelectUsuarioForAuth,
): UsuarioForAuth => ({
  ...value,
  rol: toDomainRol(value.rol),
});
